...
/// A decorative floating liquid bar that animates like a deformable wave.
/// Can be used as a progress bar, status indicator, or visual accent.
...
class _LiquidBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw wavy top edge only up to filledWidth
